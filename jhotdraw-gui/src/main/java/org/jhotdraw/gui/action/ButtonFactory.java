...
public class ButtonFactory {
    ...
    public static Collection<Action> createSelectionActions(DrawingEditor editor) {
        ...
        a.add(null); // separator
        a.add(new ArrangeAction(editor, ArrangeActionType.BRING_TO_FRONT));
        a.add(new ArrangeAction(editor, ArrangeActionType.SEND_TO_BACK));
        return a;
    }
    ...
    public static void addAlignmentButtonsTo(JToolBar bar, final DrawingEditor editor, java.util.List<Disposable> dsp) {
        ...
        dsp.add(d);
        bar.addSeparator();
        bar.add(new ArrangeAction(editor,ArrangeActionType.BRING_TO_FRONT)).setFocusable(false);
        dsp.add(d);
        bar.add(new ArrangeAction(editor,ArrangeActionType.SEND_TO_BACK)).setFocusable(false);
        dsp.add(d);
    }
